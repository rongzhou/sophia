...
import { stripQuotedText } from "../ast/braces.js";
import { hasBalancedSophiaBraces, parseSophiaTopLevelDeclarations } from "../ast/parser.js";
import {
...
export function checkFileLayout(
  ...
  if (topLevelBlocks.length === 0) {
    context.diagnostics.push(
      errorDiagnostic("CHECK-FILE-003", filePath, "Sophia v0 file has no top-level node."),
    );
  }
