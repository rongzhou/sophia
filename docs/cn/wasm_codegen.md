...
> artifact 门禁 + `sophia build`）；**A6（增量查询，与 codegen 解耦）待独立设计评审**。
>
...
>
> **后续生产化设计**：W1-W5 已解决“emit + 差测试 + artifact 门禁 + build 产物”。三方库上下文一致性、
> 动态 host import、三方 `host.wasm` VM provider、非浏览器 CLI runner 与 build bundle 见
